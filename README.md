...
- **TCC:** Avaliação de desempenho do padrão *Circuit Breaker* em microsserviços.
- **Hardware:** Automação com ESP32 para saúde (Dispensador de medicamentos).
- **Pesquisa:** Análise de dados públicos brasileiros (SIM, SINAN, IBGE) usando Python.
